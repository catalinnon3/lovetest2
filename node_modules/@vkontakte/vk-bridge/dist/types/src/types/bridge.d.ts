 ...
 */
export declare type FailedReceiveEventName<M extends ReceiveMethodName> = FailedReceiveEventMap[M];
/**
 * Getter of successful event name of a method.
 */
export declare type SuccessfulReceiveEventName<M extends ReceiveMethodName> = SuccessfulReceiveEventMap[M];
/**
 ...
 */
export declare type VKBridgeErrorEvent<M extends ReceiveMethodName> = {
    detail: {
 ...
 */
export declare type VKBridgeSuccessEvent<M extends ReceiveMethodName> = {
    detail: {
 ...
 * VK Bridge event.
 */
export declare type VKBridgeEvent<M extends ReceiveMethodName> = VKBridgeErrorEvent<M> | VKBridgeSuccessEvent<M>;
/**
 * Type of function that will be subscribed to VK Bridge events.
 */
export declare type VKBridgeSubscribeHandler = (event: VKBridgeEvent<ReceiveMethodName>) => void;
/**
 ...
 */
export declare type VKBridgeSend = <K extends RequestMethodName>(method: K, props?: RequestProps<K> & RequestIdProp) => Promise<K extends ReceiveMethodName ? ReceiveData<K> : void>;
/**
 * VK Bridge interface.
 */
